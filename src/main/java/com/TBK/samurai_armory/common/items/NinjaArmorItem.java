...
import com.TBK.samurai_armory.client.renderer.NinjaArmorRenderer;
...
public class NinjaArmorItem extends ArmorItem implements GeoItem {
    public final AnimatableInstanceCache cache= GeckoLibUtil.createInstanceCache(this);

    public NinjaArmorItem(Type p_266831_, Properties p_40388_) {
